  ...
  return (
    <div className="app-wrapper">
      <AnimatePresence mode="wait">
            ...
            <div className="cards-flex-container">
              {[cardUI, cardGraphic, cardIllustration].map((img, i) => (
                <motion.img
                  ...
                  animate={{ y: 0, opacity: 1, rotate: i === 0 ? -10 : i === 2 ? 10 : 0 }}
        ...
        {view === "illustrations" && (
          <motion.div key="illustrations" className="gallery-screen-scroll" initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div className="card-screen-header">
              <div className="header-back-link" onClick={() => setView("gallery")}>&lt; ILLUSTRATIONS</div>
