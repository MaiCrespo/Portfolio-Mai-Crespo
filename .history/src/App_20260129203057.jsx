          ...
          {projects.map((project) => (
            ...
            >
              ...
              <div className="project-image">
                <div className={`project-preview ${project.id}-preview`}>
                  {project.id === "gotit" && (
                    <div className="gotit-design">
                  ...
                  {project.id === "daybreak" && (
                    <div className="daybreak-design">
                      <div className="daybreak-bg"></div>
                      <h3>DAYBREAK</h3>
                      <div className="door-icon"></div>
                    </div>
                  )}
                  {project.id === "descent" && (
                    <div className="descent-design">
                      <div className="descent-bg"></div>
                      <h3>THE DESCENT</h3>
                      <p>Explore the Infernal Circles</p>
                    </div>
                  )}
                </div>
              </div>
