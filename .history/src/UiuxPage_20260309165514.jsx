  ...
  const projects = [
    {
      ...
      name: "Daybreak",
      cat: "Horror | Game",
      desc: "Daybreak is a multiplayer survival horror game of betrayal and sabotage. I led the visual direction, designing the world map, characters, and promotional assets.",
      img: DaybreakThumb,
      extraClass: "",
    ...
    },
    {
      ...
      desc: "Got It is a study guide for neurodiverse electrical trades students. I led the UI design, ensuring a cohesive visual identity across the app and marketing materials.",
      img: GotItThumb,
      extraClass: "",
      route: "/project/gotit",
    },
    {
      ...
      desc: "The Descent is an interactive learning game inspired by Dante's Inferno, exploring morality through the nine circles of Hell. As a solo project, I handled all illustration, prototyping, and asset production.",
      img: DescentThumb,
      extraClass: "",
