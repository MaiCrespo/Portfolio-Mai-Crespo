...
// Import All Assets (including PDFs)
...
// Process Illustrations (Zigzag Layout)
...
// Process Graphic Design (Horizontal + PDF Support)
  ...
  return (
    <div className="app-wrapper">
      <AnimatePresence mode="wait">
        ...
        {/* GRAPHIC DESIGN (SIDEWAYS SCROLL) */}
        {view === "graphicDesign" && (
          <motion.div
            key="graphicDesign"
                  ...
                  {item.isPDF ? (
                    <div className="pdf-preview-box">
                      <object
                        ...
                        className="pdf-content-embed"
                      >
                        <p>
                          Unable to display PDF. <a href={item.src}>Download</a>
                        </p>
                      </object>
                      <div
                        className="pdf-click-shield"
