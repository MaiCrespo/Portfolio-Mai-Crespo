...
const INITIAL_FACES = [
  ...
  { id: 2, src: face2, x: null, y: 300, rot: 12, size: 380, fromRight: 50 }, // Middle right, below Face6
  { id: 3, src: face3, x: -30, y: 620, rot: 6, size: 520 }, // Lower left
  { id: 4, src: face4, x: null, y: 650, rot: -10, size: 600, fromRight: 30 }, // Lower right
  { id: 5, src: face5, x: 180, y: 480, rot: 5, size: 380 }, // Left of paragraph, not overlapping
  { id: 6, src: face6, x: null, y: -80, rot: 15, size: 480, fromRight: 60 }, // Top right, partially off screen
];
