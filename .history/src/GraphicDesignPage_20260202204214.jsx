    ...
    <div className="global-page-container">
      ...
      <div className="content-pill-main scrollable-content">
        ...
        <div className="projects-grid">
          ...
          <div className="project-item">
            ...
            <div className="project-card">
              ...
              <div className="project-info">
                <h3>Poster Design</h3>
                <p>
                  A poster design for a hypothetical exhibition focusing on punk
                  rock fashion.
                </p>
                <button className="view-more-btn">VIEW MORE</button>
              </div>
          ...
          {/* Bottom Row - Centered via CSS grid-column */}
          <div className="project-item bottom-row">
            <h2 className="project-name">Manila City to El Nido</h2>
            <div className="project-card">
          ...
          <div className="project-item bottom-row">
            ...
            <div className="project-card">
              ...
              <div className="project-info">
                <h3>Poster Design</h3>
                <p>
                  A conceptual branding project for Cherubica Labs involving
