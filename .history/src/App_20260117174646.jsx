...
// Orders based on your screenshots
...
// Process Graphic Design (Filter out PDFs to prevent broken icons)
const graphics = Object.entries(graphicImages)
  ...
  .sort(
    (a, b) =>
      manualOrderGraphic.indexOf(a.name) - manualOrderGraphic.indexOf(b.name)
  );
