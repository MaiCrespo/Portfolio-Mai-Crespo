...
// Logic to pair PNG previews with PDF files
const getGraphicData = () => {
  ...
  assets.forEach(([path, mod]) => {
    ...
    if (extension === "pdf") {
      data[fileName].pdfSrc = mod.default;
    } else {
      data[fileName].imgSrc = mod.default;
    }
  });
          ...
          >
            ...
            <div className="landing-center-content">
              ...
              <p className="landing-description">
                ...
                Illustration and Graphic Design. Aside from problem-solving{" "}
                <br />
