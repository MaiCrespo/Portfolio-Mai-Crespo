...
function App() {
  return (
    <div className="app-wrapper">
      {/* Maroon Navigation Bar with Rounded Bottom Corners */}
      ...
      <main className="landing-container">
        <div className="landing-content">
          {/* Left Side: Name and Maroon Logo */}
          ...
          {/* Right Side: Bio and Profile Circle */}
          <div className="landing-right">
            ...
            <div className="profile-wrapper">
              ...
              {/* Curved Text Path centered on the maroon border */}
