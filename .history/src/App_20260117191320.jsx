...
const getGraphicData = () => {
  ...
  assets.forEach(([path, mod]) => {
    ...
    // Prioritize showing PNG images in the gallery, keep PDF for link
...
const illustrations = Object.entries(illustrationImages)
  ...
  .sort((a, b) => {
    const indexA = manualOrderIllustration.indexOf(a.name);
    const indexB = manualOrderIllustration.indexOf(b.name);
    return (indexA === -1 ? 99 : indexA) - (indexB === -1 ? 99 : indexB);
  });
  ...
  return (
    <div className="app-wrapper">
      <AnimatePresence mode="wait">
        ...
        {/* SELECTION SCREEN - UNORGANIZED CARDS */}
        {view === "gallery" && (
          <motion.div
            key="gallery"
          ...
          >
            ...
            <div className="cards-flex-container">
              <motion.img
                ...
                animate={{ y: 45, rotate: -7 }}
                whileHover={{ y: -20, rotate: 0, scale: 1.05 }}
              />
              <motion.img
                src={cardGraphic}
                className="tarot-card"
                animate={{ y: -15, rotate: 4 }}
        ...
        {/* GRAPHIC DESIGN (NOW SHOWING PNGS) */}
        {view === "graphicDesign" && (
          <motion.div
            key="graphicDesign"
