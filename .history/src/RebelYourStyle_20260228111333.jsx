      ...
      <div className="page-layout">
        ...
        <div className="scrollable-content">
          ...
          <div className="hero-image-container">
            <img src={first} alt="first" className="hero-image" />
            <img src={second} alt="second" className="hero-image" />
            <img src={third} alt="third" className="hero-image" />
          </div>
      ...
      <div className="page-layout">
        ...
        <div className="scrollable-content">
          ...
          <section className="about-section">
            <h3 className="section-label">About the Project</h3>
            <p className="project-description">
              Rebel Your Style is a concert poster design for YUNGBLUD, capturing
              the raw energy and rebellious spirit of his music. The design
              embraces bold typography, vibrant punk aesthetics, and dynamic
              compositions that reflect the artist's unapologetic attitude and
              connection with youth culture. This project explores how visual
              identity can amplify an artist's message and create an immersive
              experience that resonates with their fanbase. Every element was
              carefully crafted to embody the chaos, passion, and authenticity
              that YUNGBLUD represents.
            </p>
          </section>
          ...
          {/* Hero Image */}
          <div className="hero-image-container">
            <img src={yungblud} alt="YUNGBLUD Concert Poster 1" className="hero-image" />
            <img src={yungblud2} alt="YUNGBLUD Concert Poster 2" className="hero-image" />
          </div>
